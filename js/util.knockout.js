...
ko.validation.rules['isValidBitcoinAddress'] = {
    ...
    message: USE_TESTNET ? 'This field must be a valid TESTNET Saffroncoin address.' : 'This field must be a valid Saffroncoin address.'
};
...
ko.validation.rules['isValidUrlOrValidBitcoinAdressOrJsonBet'] = {
    ...
    message: 'This field must be a valid url or a valid Saffroncoin address'
};
